...
void ActorTick_CakeBoss_Hook(Actor* actor) {
    ...
    temp_f20 = CalcAngleBetween2DPoints(actor->pos.x, actor->pos.z, gCurrentActivePlayerPointer->pos.x, gCurrentActivePlayerPointer->pos.z);
    ...
    case BOOKS_ARM_ATTACK_COPY:
        if (func_80044E80(arg0, 5 - arg0->userVariables[2]) == 0) {
            ...
            if ((arg0->unk_134[6] == 30.0f) || (arg0->unk_124 != arg0->userVariables[4])) {
                temp_f0_2 = arg0->pos.x - gCurrentActivePlayerPointer->pos.x;
                temp_f2_3 = arg0->pos.z - gCurrentActivePlayerPointer->pos.z;
                arg0->unk_134[6] = 0;
...
loop_48:
                ...
                func_8002D36C(sp8C, CalcAngleBetween2DPoints(temp_s0->pos.x, temp_s0->pos.z, gCurrentActivePlayerPointer->pos.x, gCurrentActivePlayerPointer->pos.z), var_f2);
...
block_53:
    ...
    case BOOKS_PULL_ARMS_IN_COPY:
        temp_f20_4 = arg0->pos.x - gCurrentActivePlayerPointer->pos.x;
        temp_f22_4 = arg0->pos.z - gCurrentActivePlayerPointer->pos.z;
    ...
    case BOOKS_PHASE1_WALK_BEFORE_ARM_PLANT:
        ...
        if (arg0->pos.z >= 0.0f) {
            if (arg0->pos.x < gCurrentActivePlayerPointer->pos.x) {
                arg0->unk_120 = 1;
            } else {
                arg0->unk_120 = 0;
            }
            if (arg0->pos.z < gCurrentActivePlayerPointer->pos.z) {
            ...
            temp_f12 = (f32) (((f64) ((((f32) (1 - (arg0->unk_120 * 2)) * arg0->unk_134[5] * 90.0f) + CalcAngleBetween2DPoints(gCurrentActivePlayerPointer->pos.x, gCurrentActivePlayerPointer->pos.z, arg0->pos.x, arg0->pos.z)) * 2.0f) * PI) / 360.0);
            arg0->unk_134[3] = CalcAngleBetween2DPoints(arg0->pos.x, arg0->pos.z, (__cosf(temp_f12) * 300.0f) + gCurrentActivePlayerPointer->pos.x, gCurrentActivePlayerPointer->pos.z - (__sinf(temp_f12) * 300.0f));
            arg0->unk_134[4] = 0.0f;
        } else {
            arg0->unk_F0++;
    ...
    case BOOKS_CHOOSE_INITIAL_PHASE2_ANGLE:
        for (i = 1; i < 0x21; i++) {
            ...
            if (IsAngleWithinTolerance(CalcAngleBetween2DPoints(arg0->pos.x, arg0->pos.z, gCurrentActivePlayerPointer->pos.x, gCurrentActivePlayerPointer->pos.z), CalcAngleBetween2DPoints(arg0->pos.x, arg0->pos.z, arg0->unk_134[3], arg0->unk_134[4]), 30.0f) == 0) {
                continue;
            }
            break;
        }
    ...
    case DO_PHASE2_MOVEMENT:
        ...
        if (((SQ(temp_f2_6)) + (SQ(temp_f12_2))) < (2.0f * (SQ(arg0->unk_160)))) {
            ...
            if (arg0->unk_120 != 0) {
                ...
                if (arg0->unk_120 == 0) {
                    arg0->unk_134[5] = CalcAngleBetween2DPoints(arg0->pos.x, arg0->pos.z, gCurrentActivePlayerPointer->pos.x, gCurrentActivePlayerPointer->pos.z);
                } else {
                    arg0->unk_134[5] = CalcAngleBetween2DPoints(arg0->pos.x, arg0->pos.z, gCurrentActivePlayerPointer->pos.x, gCurrentActivePlayerPointer->pos.z) - 30.0f;
    ...
    case BOOKS_DO_STRAIGHT_SHOT:
        spAC = arg0->pos.x - gCurrentActivePlayerPointer->pos.x;
        spA8 = arg0->pos.z - gCurrentActivePlayerPointer->pos.z;
        if ((gCurrentActivePlayerPointer->amountLeftToShoot != 0) && (arg0->userVariables[4] >= 4)) {
            func_8002F6DC(&arg0->unk_90, CalcAngleBetween2DPoints(arg0->pos.x, arg0->pos.z, gCurrentActivePlayerPointer->pos.x, gCurrentActivePlayerPointer->pos.z));
        }
    ...
    case BOOKS_DO_CURVED_SHOT:
        spA4 = arg0->pos.x - gCurrentActivePlayerPointer->pos.x;
        ...
        WrapDegrees(&arg0->unk_90);
        arg0->userVariables[4]++;
        if ((arg0->userVariables[4] == 0x70) || (gCurrentActivePlayerPointer->amountLeftToShoot != 0) || ((SQ(spA4) + SQ(spA0)) < 640000.0f)) {
            arg0->userVariables[2] = BOOKS_CHOOSE_INITIAL_PHASE2_ANGLE;
            arg0->unk_120 = Random(0, 99999999) % MAX_MOVES;
        }
        break;
